<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Delivery.aspx.cs" Inherits="SingaporeFloristNS.Web.Admin.Delivery" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:GridView ID="gvDelivery" runat="server" DataKeyNames="DeliveryID">
            </asp:GridView>
        </div>
    </form>
</body>
